...
//1ro cachamos datos, luego UPDATE en la bd
        ...
        mysqli_query($con,"UPDATE persona p, usuario u SET p.nombre='$nombreEdit', p.apellidos='$apellidosEdit', p.telefono='$telEdit', p.ciudad='$ciudadEdit', u.idTipoUsuario='$rolEdit', u.correo='$correoEdit'  WHERE p.idPersona=u.idPersona AND p.idPersona= $idPersona");
        echo 1;
...
//parte de agregar nuevo usuario
    }elseif($action=="getNuevoUsuario"){
        $idPersona=(isset($_REQUEST['idPersona'])&& $_REQUEST['idPersona'] !=NULL)?$_REQUEST['idPersona']:'';
